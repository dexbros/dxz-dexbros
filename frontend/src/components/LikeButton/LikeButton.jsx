...
// const LikeButton = ({ btnClicked, setBtnClicked, postData, user, handleSubmitLike, handleRemoveLike }) => {
...
//         <motion.div className="like_btn_container">
...
//                 }
//               </> :
//               <AiOutlineLike className="post_like_icon" />
//           }
//           </motion.button>
//         </motion.div>
//       </motion.div>
