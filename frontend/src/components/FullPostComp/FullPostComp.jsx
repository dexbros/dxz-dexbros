...
const FullPost = ({
  ...
  const [hasPinned, setHasPinned] = React.useState(postData.pinned);
  const [postDelete, setPostDelete] = React.useState(postData.isDelete);
        ...
        <>
          {!postDelete && (
            <div className='social_full_post'>
              ...
              {hasPinned > 0 && (
                <div>
                  <span class='ico-_pinned_one'></span>
                </div>
              )}
              ...
              {postData.is_share && (
                <div className='share_container'>
                    ...
                    <div className='social_media_post_card_header'>
                      ...
                      <div className='post_creator_info'>
                        <>
                          {/* creator name */}
                          <span className='creator_name' id='profile'>
                            {width <= 506 && postData.share.u_fn.length > 9 ? (
                              <>{postData.share.u_fn.slice(0, 9) + ".."}</>
                            ) : (
                              <>{postData.share.u_fn}</>
                            )}{" "}
                            {width <= 506 && postData.share.u_ln.length > 5 ? (
                  ...
                  <div className='post_card_body' id='post_body'>
                    <span className='main_body_text' id='post_body'>
                      {postData.share.content.split(" ").map((val, index) => (
                        <span
                          id='post_body'
                          key={index}
              ...
              <div className='social_post_main_header'>
                <div className='social_media_post_card_header'>
                  <img
                    src={`${process.env.REACT_APP_GOOGLE_CLOUD_IMAGE_LINK}${postData.u_img}`}
                    className='posted_user_avatar'
                    id='profile'
                  />
                ...
                {!postData.is_share && (
                  <Menu
                    ...
                    {sharePrivacy === "all" ? (
                      <MenuItem id='share' className={"social_post_menu_item"}>
                        <>{t("Share")}</>
                      </MenuItem>
                    ) : (
                      <>
                    ...
                    {postData.u_dun === user.handleUn && (
                      <MenuItem id='delete' className={"social_post_menu_item"}>
                        {t("Delete")}
                      </MenuItem>
                    )}
                  </Menu>
              ...
              {postData.isDisable ? (
                ...
                <div className={"post_card_body"} id='post_body'>
                      ...
                      <span
                        ...
                        {val.includes("@") ? (
                          ...
                          <>
                            {val.includes("$") ? (
                              <Link
                                to={`/user/profile/${checkCryptoMention(val)}`}
                  ...
                  {postData.video && (
                    // <img   id="post_body" />
                    <video controls autoPlay className='post_card__body_image'>
