  ...
  return (
    <React.Fragment>
      <div
        ...
        <button className='info_post_btn help_btn' id='like'>
          {t("Like")}
        </button>

        <button id='comment' className='info_post_btn cmnt_btn'>
          Comment
        </button>

        <button className='info_post_btn unhelp_btn' id='importent'>
          {t("Important")}
        </button>

        <button className='info_post_btn misleading_btn' id='scam'>
          {t("Scam")}
        </button>
      </div>
