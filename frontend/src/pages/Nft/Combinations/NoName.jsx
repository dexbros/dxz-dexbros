...
const NoName = ({ post, isNameVisible, token }) => {
  ...
  const handleImageChange = (e) => {
    const item = document.querySelector(".nft_post_box");
  ...
  const domRef1 = document.querySelector(".edit_combination_post_section");

  // /Create blob file
  const createBlobFile = (url) => {
    console.log("url: ", url);
    fetch(URL) // Replace with your image URL
  ...
  // Convert into image
  const convertIntoImage = async () => {
    setLoading(true);
    // const data = await createBlobFile();
    try {
      domtoimage
        .toPng(domRef)
        .then((dataUrl) => {
  ...
  const saveImageHandle = () => {
    ...
    fetch("http://localhost:3100/api/posts/create/nft", requestOptions)
  ...
  return (
    <div className='combination_section'>
        ...
        <CustomPostFormModal
          ...
          title={
            <div className='preview_modal_title'>
              ...
              {!isNextPage ? (
                <span className='preview_modal_title_text'>
                  Preview and Edit
                </span>
              ) : (
                <span className='preview_modal_title_text'>Preview</span>
              )}
            </div>
          }
          body={
                ...
                <div className='edit_combination_post_section'>
                  <div
                    ...
                    <div className='nft_post_header'>
                      ...
                      {/* username */}
                      <div className='nft_post_user_username'>
                        @{post.u_dun}
                      </div>
                  ...
                  {!isNextPage ? (
                    ...
                    <>
                      ...
                      <button
                        ...
                        {loading ? <span class='__loader'></span> : <>Next</>}
                      </button>
                    </>
                  )}
                </div>
      ...
      <p className='combination_section_title'>Without name</p>
