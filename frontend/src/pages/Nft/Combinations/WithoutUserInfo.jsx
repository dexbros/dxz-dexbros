...
const WithoutUserInfo = ({ post, isNameVisible }) => {
  ...
  return (
    <div className='combination_section'>
              ...
              {!url ? (
                <div className='edit_combination_post_section'>
                  <div
                    ...
                    {/* Header */}
                    <div className='nft_post_header'></div>
      ...
      <p className='combination_section_title'>Without user info</p>
...
export default WithoutUserInfo;
